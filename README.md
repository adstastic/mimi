...
- independently configurable silence auto-stop, stop detection mode, microphone input, shortcut Return-after-paste, and ambient pre/post-paste keystrokes and delays
